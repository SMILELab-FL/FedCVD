...
from ...core.pipeline.client import ClientTrainer
from ...core.pipeline.client.trainer import SerialClientTrainer
...
class SGDSerialClientTrainer(SerialClientTrainer):
    ...
    def __init__(self, model, cuda=False, device=None, logger=None, personal=False) -> None:
        super().__init__(model,  cuda, device, personal)
        self._LOGGER = Logger() if logger is None else logger
        self.cache = {}

    def setup_dataset(self, dataset: FedDataset):
        self.dataset = dataset
    ...
    def local_process(self, global_round, payload, id_list):
        model_parameters = payload[0]
