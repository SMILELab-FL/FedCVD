...
def get_best_device() -> torch.device:
    """Return best device (:class:`torch.device`) with the largest free memory."""
...
def get_best_device_v2() -> torch.device:
    """This function is for pytorch higher than 2.0"""
    """Return best device (:class:`torch.device`) with the largest free memory."""
    if torch.cuda.is_available():
        return get_best_gpu()
...
def get_best_gpu():
    """Return gpu (:class:`torch.device`) with the largest free memory."""
