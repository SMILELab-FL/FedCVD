...
class UNETR(nn.Module):
    ...
    def __init__(
        ...
        Examples::
            ...
            >>> net = UNETR(in_channels=1, out_channels=4, img_size=(96,96), feature_size=32, norm_name='batch')

            # for 4-channel input 3-channel output with patch size of (128,128,128), conv position embedding and instance norm
            >>> net = UNETR(in_channels=4, out_channels=3, img_size=(128,128), pos_embed='conv', norm_name='instance')
...
if __name__ == "__main__":
    ...
    #         dropout_rate=dropout_rate
    #     )
    sample = torch.randn((8, 1, 112, 112))
    out = model(sample)
    print(out.shape)